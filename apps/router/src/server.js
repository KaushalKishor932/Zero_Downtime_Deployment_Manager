...
let lastRPS = { active: 0, canary: 0 };

// Snapshot metrics every 1 second to provide stable "RPS" without UI flickering
setInterval(() => {
    lastRPS.active = metrics.activeRequests;
    lastRPS.canary = metrics.canaryRequests;
...
app.get('/stats', (req, res) => {
    res.json({
        activeRequestRate: lastRPS.active, // requests per sec
        canaryRequestRate: lastRPS.canary,
